...
class Combatiente(Entity):
    def __init__(self, nombre, salud, fuerza, color_combate, position):
        super().__init__(
            model='cube',
            color=color_combate,
            position=position,
...
# Equipos
humanos = [
    Combatiente("Humano 1", 100, 15, color.azure, position=(-3, 0, 0)),
    Combatiente("Humano 2", 100, 15, color.azure, position=(-1, 0, 0))
]

gorilas = [
    Combatiente("Gorila 1", 150, 20, color.brown, position=(1, 0, 0)),
    Combatiente("Gorila 2", 150, 20, color.brown, position=(3, 0, 0))
]
